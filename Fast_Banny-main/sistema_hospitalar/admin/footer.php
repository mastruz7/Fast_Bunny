                    ...
                    <div class="col-md-4 col-sm-4"> 
                         <div class="footer-thumb">
                              <div class="opening-hours">
                                   <h4 class="wow fadeInUp" data-wow-delay="0.4s">Horários</h4>
                                   <p>Segunda - Sexta <span>08:00 - 18:00</span></p>
                                   <p>Sábado <span>09:00 - 14:00</span></p>
                                   <p>Domingo <span>Fechado</span></p>
                              </div> 

                              <ul class="social-icon">
                                   <li><a href="https://pt-br.facebook.com/" class="fa fa-facebook-square" attr="facebook icon"></a></li>
                    ...
                    <div class="col-md-12 col-sm-12 border-top">
                         <div class="col-md-4 col-sm-6">
                              <div class="copyright-text"> 
                                   <p>Copyright &copy; 2023 Fastbunny</p>
                              </div>
                         </div>
